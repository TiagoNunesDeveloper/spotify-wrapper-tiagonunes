...
<script src="tiagonunes-spotify-wrapper.umd.js"></script>

<!-- to import minified version -->
<script src="tiagonunes-spotify-wrapper.umd.min.js"></script>
```

After that the library will be available to the Global as `spotifyWrapper`. Follow an example:

```js
const albums = tiagonunesSpotifyWrapper.searchAlbums('Choosen Artist');
```
...
```js
searchTracks('Uma nova história')
  .then(data => {
    // do what you want with the data
  })
```
...
| ![Willian Justen](https://avatars1.githubusercontent.com/u/26446403?v=3&s=150)|
|:---------------------:|
|  [Tiago Nunes](https://github.com/tiagonunesdeveloper/)   |

See also the list of [contributors](https://github.com/tiagonunesdeveloper/spotify-wrapper-tiagonunes/contributors) who participated in this project.
